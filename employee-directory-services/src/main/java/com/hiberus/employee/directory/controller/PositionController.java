...
public class PositionController {
    ...
    @ApiResponses(value = { @ApiResponse(responseCode = "200", description = "List all positions",
    ...
    public ResponseEntity<Response<List<Position>>> findAll() {
        return new ResponseEntity<>(Response.<List<Position>>builder().data(positionService.findAll())
